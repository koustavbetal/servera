...
def generate_launch_description():
    ...
    bringup_dir = get_package_share_directory('servera_nav')
    launch_dir = os.path.join(bringup_dir, 'launch')
    servera_description_share = FindPackageShare("servera_description")
    map_yaml= PathJoinSubstitution([servera_description_share, 'maps', 'warehouse.yaml'])
    ...
    bringup_cmd_group = GroupAction(
        [
            ...
            IncludeLaunchDescription(
                PythonLaunchDescriptionSource(
                    os.path.join(launch_dir, 'navigation_hw_launch.py')
                ),
                launch_arguments={
                    'namespace': namespace,
                    'use_sim_time': use_sim_time,
